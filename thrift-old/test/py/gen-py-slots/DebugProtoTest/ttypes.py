  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.b1 = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.STRING:
          self.b2 = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.STRING:
          self.b3 = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 5:
        if ftype == TType.STRING:
          self.b4 = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.STRING:
          self.b5 = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.STRING:
          self.b6 = iprot.readString()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.empty_struct_field = Empty()
          self.empty_struct_field.read(iprot)
        else:
          iprot.skip(ftype)
      elif fid == 11:
        if ftype == TType.LIST:
...
class SingleMapTestStruct:
  ...
  def validate(self):
    if self.i32_map is None:
      raise TProtocol.TProtocolException(message='Required field i32_map is unset!')
    return
...
class StructWithASomemap:
  ...
  def validate(self):
    if self.somemap_field is None:
      raise TProtocol.TProtocolException(message='Required field somemap_field is unset!')
    return
