...
Calculator_SayHello_args::~Calculator_SayHello_args() throw() {
}


uint32_t Calculator_SayHello_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Calculator_SayHello_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Calculator_SayHello_args");
...
Calculator_SayHello_pargs::~Calculator_SayHello_pargs() throw() {
}


uint32_t Calculator_SayHello_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Calculator_SayHello_pargs");
...
Calculator_SayHello_result::~Calculator_SayHello_result() throw() {
}


uint32_t Calculator_SayHello_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Calculator_SayHello_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Calculator_SayHello_result");
...
Calculator_SayHello_presult::~Calculator_SayHello_presult() throw() {
}


uint32_t Calculator_SayHello_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void CalculatorClient::SayHello(std::string& _return, const std::string& request)
{
  send_SayHello(request);
  recv_SayHello(_return);
}

void CalculatorClient::send_SayHello(const std::string& request)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("SayHello", ::apache::thrift::protocol::T_CALL, cseqid);

  Calculator_SayHello_pargs args;
...
void CalculatorClient::recv_SayHello(std::string& _return)
{
  ...
  Calculator_SayHello_presult result;
...
void CalculatorProcessor::process_SayHello(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Calculator.SayHello", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Calculator.SayHello");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Calculator.SayHello");
  }

  Calculator_SayHello_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Calculator.SayHello", bytes);
  }

  Calculator_SayHello_result result;
  try {
    iface_->SayHello(result.success, args.request);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Calculator.SayHello");
    }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Calculator.SayHello");
  }
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Calculator.SayHello", bytes);
  }
}
...
void CalculatorConcurrentClient::SayHello(std::string& _return, const std::string& request)
{
  int32_t seqid = send_SayHello(request);
  recv_SayHello(_return, seqid);
}

int32_t CalculatorConcurrentClient::send_SayHello(const std::string& request)
{
...
void CalculatorConcurrentClient::recv_SayHello(std::string& _return, const int32_t seqid)
{
