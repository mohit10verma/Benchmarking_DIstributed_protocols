...
class HelloInt:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('HelloInt')
...
class HelloDouble:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('HelloDouble')
    if self.value is not None:
...
class HelloString:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('HelloString')
...
class PhoneNumber:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'number', None, "6085719874", ), # 1
    (2, TType.I32, 'op', None, None, ), # 2
  )

  def __init__(self, number=thrift_spec[1][4], op=None,):
    self.number = number
    self.op = op
...
class Person:
  ...
  thrift_spec = (
    ...
    (4, TType.STRUCT, 'phone', (PhoneNumber, PhoneNumber.thrift_spec), None, ), # 4
  )
  ...
  def write(self, oprot):
    ...
    if self.phone is not None:
      oprot.writeFieldBegin('phone', TType.STRUCT, 4)
      self.phone.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
