...
class CrazyNesting(object):
  ...
  def validate(self):
    if self.list_field is None:
      raise TProtocol.TProtocolException(message='Required field list_field is unset!')
    return
...
class VersioningTestV2(object):
  ...
  def write(self, oprot):
    ...
    if self.newmap is not None:
      ...
      for kiter99,viter100 in self.newmap.items():
        oprot.writeI32(kiter99)
        oprot.writeI32(viter100)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class GuessProtocolStruct(object):
      ...
      if fid == 7:
        if ftype == TType.MAP:
          ...
          for _i119 in xrange(_size115):
            ...
            self.map_field[_key120] = _val121
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.map_field is not None:
      ...
      for kiter122,viter123 in self.map_field.items():
...
class LargeDeltas(object):
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i134 in xrange(_size130):
            ...
            self.big_numbers.append(_elem135)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.big_numbers is not None:
      ...
      for iter137 in self.big_numbers:
...
class NestedListsI32x2(object):
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i142 in xrange(_size138):
            ...
            iprot.readListEnd()
            self.integerlist.append(_elem143)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.integerlist is not None:
      ...
      for iter150 in self.integerlist:
        oprot.writeListBegin(TType.I32, len(iter150))
...
class NestedListsI32x3(object):
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i156 in xrange(_size152):
            ...
            iprot.readListEnd()
            self.integerlist.append(_elem157)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.integerlist is not None:
      oprot.writeFieldBegin('integerlist', TType.LIST, 1)
      oprot.writeListBegin(TType.LIST, len(self.integerlist))
      for iter170 in self.integerlist:
        oprot.writeListBegin(TType.LIST, len(iter170))
...
class NestedListsBonk(object):
          ...
          for _i237 in xrange(_size233):
            ...
            for _i243 in xrange(_size239):
              ...
              for _i249 in xrange(_size245):
                _elem250 = Bonk()
                _elem250.read(iprot)
                _elem244.append(_elem250)
              iprot.readListEnd()
              _elem238.append(_elem244)
            iprot.readListEnd()
            self.bonk.append(_elem238)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.bonk is not None:
      ...
      for iter251 in self.bonk:
        oprot.writeListBegin(TType.LIST, len(iter251))
        for iter252 in iter251:
          oprot.writeListBegin(TType.STRUCT, len(iter252))
          for iter253 in iter252:
            iter253.write(oprot)
          oprot.writeListEnd()
        oprot.writeListEnd()
      oprot.writeListEnd()
...
class StructA(object):
  ...
  def validate(self):
    if self.s is None:
      raise TProtocol.TProtocolException(message='Required field s is unset!')
    return
...
class StructB(object):
  ...
  def validate(self):
    if self.ab is None:
      raise TProtocol.TProtocolException(message='Required field ab is unset!')
    return
